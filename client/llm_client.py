...
class LLMClient:
    ...
    async def chat_completion(self, 
        ...
        if stream:
            async for event in self._stream_response(client, kwargs): # these are protected ones that are only present inside this
                yield event
        else:
    ...
    async def _stream_response(self,
                ...
                # we will go to every chunk in response
                # there is only one finish token and one token usage
                ...
                async for chunk in response:
                     ...
                     if not chunk.choices:      # if we donot get choices we just continue
                          continue
